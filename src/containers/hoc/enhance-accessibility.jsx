...
function withAccessible() {
  return (WrappedComponent) => {
    // console.log('AccessibleHOCCCCC +++++++ WrappedComponent', WrappedComponent);
    ...
    ScreenReaderAccessibleComponent.WrappedComponent = WrappedComponent;
