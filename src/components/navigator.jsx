      ...
      <div className="row pt-2 pb-1 pt-md-3 pb-md-2">
        ...
        <div className="col-6">
          <div className="float-right">
              ...
              <button type="button" className="btn btn-primary"><i className="fa fa-upload" aria-hidden="true"></i> <span className="d-none d-sm-inline-block">Submit a Sign</span></button>
          </div>
        </div>
      </div>
    </div>
